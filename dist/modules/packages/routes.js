...
const packagesService = __importStar(require("./packages.service"));
const error_handler_1 = require("../../middleware/error-handler");
exports.packagesRouter = (0, express_1.Router)();
exports.packagesRouter.get('/', (0, error_handler_1.asyncHandler)(async (req, res) => {
...
exports.packagesRouter.get('/:id', (0, error_handler_1.asyncHandler)(async (req, res) => {
