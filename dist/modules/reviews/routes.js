...
exports.reviewsRouter.get('/:destinationId/reviews', (0, error_handler_1.asyncHandler)(async (req, res) => {
    res.success(await reviewsService.findByDestination(req.params.destinationId));
}));
exports.reviewsRouter.post('/:destinationId/reviews', auth_1.requireAuth, (0, validate_1.validateBody)(schemas_1.createReviewSchema), (0, error_handler_1.asyncHandler)(async (req, res) => {
