...
exports.needsPostgresSsl = needsPostgresSsl;
 ...
 */
function postgresUrlHostname(databaseUrl) {
    if (!databaseUrl?.trim())
        return null;
    try {
 ...
 */
function needsPostgresSsl(options) {
 ...
 */
function resolvePrismaDatabaseUrl(options) {
    const { databaseUrl, nodeEnv, dbSsl } = options;
    if (!needsPostgresSsl({ databaseUrl, nodeEnv, dbSsl }))
        return databaseUrl;
...
//# sourceMappingURL=pg-ssl.js.map